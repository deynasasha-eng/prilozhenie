document.addEventListener('DOMContentLoaded', function() {
    ...
    const clubsData = {
        science: [
            {
                name: "Студенческое научное общество Герценского университета",
        ...
        social: [
            {
                ...
                link: "https://vk.ru/dobrocentrrgpu",
